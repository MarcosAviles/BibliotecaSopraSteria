    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("Registrar")!=null){
            if(CategoriaDAO.registrar(c)){
                ...
                request.setAttribute("mensaje", "La Categoria NO se ha registrado");
            }
        }
        else if(request.getParameter("Eliminar")!=null){
            if(CategoriaDAO.eliminar(c)){
                request.setAttribute("mensaje", "La Categoria se ha eliminado correctamente");
            }
            else{
                request.setAttribute("mensaje", "La Categoria NO se ha eliminado");
            }
        }
        else{
